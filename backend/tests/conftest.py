...
_SQLITE_SCHEMA = [
    ...
    CREATE TABLE IF NOT EXISTS blobs (
        ...
        phash_q2 INTEGER,
        phash_q3 INTEGER,
        dedup_scanned_threshold INTEGER,
        dedup_scanned_phash_int INTEGER,
        dedup_scanned_version INTEGER,
        occurrence_revision INTEGER NOT NULL DEFAULT 0,
    ...
    CREATE TABLE IF NOT EXISTS blob_relationships (
        ...
        diff_type TEXT,
        context_scope TEXT,
        context_revision_a INTEGER,
        context_revision_b INTEGER,
        decision TEXT,
