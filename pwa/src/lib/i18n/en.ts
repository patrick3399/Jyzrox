const en: Record<string, string> = {
  ...
  'explorer.manualFieldsLocked': 'Manual values are locked. Source refreshes will show a proposed diff instead of overwriting them.',
  'explorer.keep': 'Keep',
  'explorer.set': 'Set',
  ...
  'explorer.merge404Warning': 'Sources will be moved to Trash and their old routes will immediately return 404. Restoring a source does not undo the merged target.',
