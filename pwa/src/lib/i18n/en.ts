const en: Record<string, string> = {
  ...
  'settingsCategory.tagDatabase': 'Tag Database',
  'settingsCategory.tagDatabaseDesc': 'Import community tag translations',
  ...
  // ── Settings extra ──
  'settings.tagDatabaseDesc': 'Import the EhTagTranslation database for Chinese tag names.',
  ...
  'import.batch.patternHelp': '{artist}, {category}, {title}, {_} (skip)',
  ...
  'import.batch.category': 'Category',
  ...
  'datasets.captionReview': 'Caption Review',
  'datasets.captionReviewHint': 'Edit one image\'s caption, or apply a change across the whole dataset.',
