const en: Record<string, string> = {
  ...
  'dashboard.quickLinks.browse': 'Browse',
  ...
  'library.hideSelected': 'Hide ({count})',
  'library.hideSelectedConfirm': 'Hide {count} selected image(s)? They won\'t appear in re-imports.',
  'library.hidingImages': 'Hiding...',
  'library.imagesHidden': '{count} image(s) hidden',
  'library.hideImageFailed': 'Failed to hide image',
  'library.showExcluded': 'Show Hidden ({count})',
  'library.hideExcluded': 'Hide Hidden',
  'library.excludedImages': 'Hidden Images',
  'library.noExcluded': 'No hidden images',
  'library.restoreConfirm': 'Restore this image? It will reappear on next re-import.',
  'library.restoreExcluded': 'Restore',
  'library.restored': 'Image unblocked — re-import to restore',
  'library.restoreFailed': 'Failed to restore image',
  ...
  'reader.downloadingCount': '{count} images imported so far',
  ...
  'tag.translationTooltip': 'Translation: {translation}',
  'tag.noTranslation': 'No translation available',
  ...
  'subscriptions.downloading': 'Downloading...',
