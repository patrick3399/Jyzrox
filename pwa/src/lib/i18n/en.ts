const en: Record<string, string> = {
  ...
  'export.datasetSubtitle': 'Export a reviewed dataset with trainer configs, captions, splits, buckets, and provenance.',
  ...
  'settings.gridDensityDesc': 'Choose the default spacing and responsive column density for Library cards.',
  ...
  'datasets.captionReviewHint': 'Generate natural-language captions, edit each image, or apply batch changes.',
