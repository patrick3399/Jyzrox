const en: Record<string, string> = {
  ...
  'dashboard.quickLinks.collectionsDesc': 'Manage gallery collections',
  ...
  'library.rescanning': 'Rescanning...',
  'library.rescanStarted': 'Rescan started',
  'library.rescanFailed': 'Rescan failed',
  ...
  'collections.confirmDelete': 'Delete this collection? Galleries inside will not be removed.',
  'collections.noCollections': 'No collections yet.',
  'collections.removeGallery': 'Remove from Collection',
  'collections.galleryRemoved': 'Gallery removed from collection',
  'collections.galleryCount': '{count} galleries',
  'collections.empty': 'This collection is empty.',
  'collections.coverGallery': 'Cover Gallery',
  ...
  'settings.swarmUi': 'SwarmUI image processing',
  'settings.swarmUiDesc': 'Enable remote AI refinement and upscaling.',
  'settings.swarmUiUrl': 'SwarmUI service URL',
  'settings.captioner': 'Natural-language captioner',
  'settings.captionerDesc': 'Enable Florence-2 or JoyCaption dataset captions.',
  'settings.captionerUrl': 'Caption service URL',
  ...
  'settings.tagTranslationAuto': 'Automatic (Chinese UI only)',
  'settings.tagTranslationOff': 'Off',
  'settings.tagTranslationZhCN': 'Simplified Chinese',
  'settings.tagTranslationZhTW': 'Traditional Chinese',
  ...
  'settings.languageAutomatic': 'Use browser default',
  ...
  'login.logoutFailed': 'Logout failed. Please try again.',
  ...
  'export.datasetSubtitle':
    'Export a reviewed dataset with trainer configs, captions, splits, buckets, and provenance.',
  'export.noDatasets': 'Create a dataset before exporting training data.',
  'export.createDataset': 'Open dataset manager',
  'export.chooseDataset': 'Choose dataset',
  'export.datasetStats': '{images} included · {excluded} excluded',
  'export.options': 'Export options',
  'export.preset': 'Trainer preset',
  'export.triggerWord': 'Trigger word',
  'export.repeats': 'Repeats',
  'export.validationPercent': 'Validation split (%)',
  'export.resolution': 'Maximum resolution',
  'export.originalResolution': 'Keep original',
  'export.precomputeBuckets': 'Precompute 64px aspect-ratio buckets',
  'export.includeMetadata': 'Include source, tags, and confidence sidecars',
  'export.downloadDataset': 'Download dataset',
  'export.downloading': 'Downloading...',
  'export.kohyaZip': 'Kohya ZIP',
  'export.columnId': 'ID',
  'export.columnTitle': 'Title',
  'export.columnSource': 'Source',
  'export.columnPages': 'Pages',
  'export.columnTags': 'Tags',
  'export.columnExport': 'Export',
  ...
  'library.restoreHidden': 'Restore',
  'library.restoreHiddenConfirm': 'Restore this hidden image?',
  'library.hiddenRestored': 'Image restored',
  ...
  'artists.unfollow': 'Unfollow',
  'artists.following': 'Following',
  'artists.followedArtists': 'Followed Artists',
  'artists.autoDownload': 'Auto-download',
  'artists.autoDownloadOn': 'Auto-download enabled',
  'artists.autoDownloadOff': 'Auto-download disabled',
  'artists.checkUpdates': 'Check Updates',
  'artists.checkingUpdates': 'Checking for updates...',
  'artists.updatesChecked': 'Update check started',
  'artists.followSuccess': 'Now following {name}',
  'artists.unfollowSuccess': 'Unfollowed {name}',
  'artists.lastChecked': 'Last checked: {date}',
  'artists.neverChecked': 'Never checked',
  'artists.viewFollowed': 'Followed',
  'artists.viewAll': 'All Artists',
  'artists.noFollowed': 'No followed artists yet.',
  ...
  'queue.jobDetail': 'Job Details',
  'queue.jobProgress': 'Progress',
  'queue.jobError': 'Error',
  'queue.jobMeta': 'Details',
  'queue.jobCurrentFile': 'Current file',
  'queue.jobGdlState': 'State',
  'queue.jobSkipped': 'Skipped (already saved)',
  'queue.jobImportSkipped': 'Filtered during import',
  'queue.jobRecentLog': 'Recent gallery-dl log',
  'queue.gdlStateStarting': 'Starting',
  'queue.gdlStateDownloading': 'Downloading',
  'queue.gdlStateSleeping': 'Sleeping (rate-limit cooldown)',
  'queue.gdlStateRateLimited': 'Rate-limited (HTTP 429)',
  'queue.gdlStateRetrying': 'Retrying after server error',
  'queue.gdlStatePaused': 'Paused',
  'queue.gdlStateCancelled': 'Cancelled',
  'queue.gdlStateDone': 'Done',
  ...
  'reader.loadingGallery': 'Loading gallery...',
  'reader.loadingImages': 'Loading images...',
  'reader.loadingImagesProgress': 'Loading images... {loaded}/{total}',
  'reader.loadingFavoriteImages': 'Loading favorite images... {loaded}',
  'reader.noFavoriteImages': 'No favorite images found.',
  'reader.invalidArtistId': 'Invalid artist ID.',
  'reader.loadArtistImagesFailed': 'Failed to load artist images.',
  'reader.loadFavoriteImagesFailed': 'Failed to load favorite images.',
  ...
  'browse.searchByImage': 'Search EH by image',
  'browse.imageOriginalJpeg':
    'EH requires the original JPEG bytes; the image will not be recompressed.',
  'browse.similarityScan': 'Similarity scan',
  ...
  'browse.anyLanguage': 'Any language',
  'browse.favoriteNote': 'Favorite note',
  'browse.torrents': 'Torrents',
  'browse.archive': 'Archive',
  'browse.sourceLink': 'Source',
  'browse.parentGallery': 'Parent',
  'browse.newerVersions': 'Newer versions',
  'browse.searchName': 'Name',
  'browse.searchTags': 'Tags',
  'browse.searchDescription': 'Description',
  'browse.torrentFilenames': 'Torrent filenames',
  'browse.onlyTorrents': 'Only torrents',
  'browse.lowPowerTags': 'Low-power tags',
  'browse.downvotedTags': 'Downvoted tags',
  'browse.showExpunged': 'Show expunged',
  'browse.disableLanguageFilter': 'Disable language filter',
  'browse.disableUploaderFilter': 'Disable uploader filter',
  'browse.disableTagFilter': 'Disable tag filter',
  ...
  'browse.addedToFavorites': 'Added to Favorites {favcat}',
  'browse.addFavoriteFailed': 'Failed to add favorite',
  'browse.removedFromFavorites': 'Removed from favorites',
  'browse.removeFavoriteFailed': 'Failed to remove favorite',
  'browse.queuedJob': 'Added to queue (job: {jobId})',
  'browse.queueFailed': 'Failed to add to queue',
  ...
  'browse.renameSavedSearch': 'Rename',
  'browse.searchRenamed': 'Search renamed',
  'browse.renameSearchPlaceholder': 'New name...',
  ...
  'settings.renameToken': 'Rename',
  'settings.tokenRenamed': 'Token renamed',
  'settings.enterTokenName': 'New name...',
  ...
  'credentials.ehPassword': 'Password',
  'credentials.ehLoginButton': 'Login',
  'credentials.ehLoggingIn': 'Logging in...',
  'credentials.ehLoginSuccess': 'E-Hentai login successful',
  'credentials.ehLoginFailed': 'Login failed',
  'credentials.checkCookies': 'Validate Cookies',
  'credentials.checkingCookies': 'Validating...',
  'credentials.cookiesValid': 'Cookies are valid',
  'credentials.cookiesInvalid': 'Cookies are invalid or expired',
  ...
  'plugins.hasProcess': 'Image processing',
  'plugins.serviceOnline': 'Service online',
  'plugins.serviceOffline': 'Service offline',
  'library.aiUpscale': 'AI Upscale',
  'library.aiUpscaleOffline': 'SwarmUI is offline or disabled',
  'library.aiUpscaleImage': 'Image',
  'library.aiUpscaleModel': 'Refiner model',
  'library.aiUpscaleDefaultModel': 'Service default',
  'library.aiUpscaleScale': 'Scale',
  'library.aiUpscaleStart': 'Queue upscale',
  'library.aiUpscaleQueued': 'AI upscale queued',
  ...
  'pixiv.read': 'Read',
  'pixiv.userWorks': 'Works',
  'pixiv.userBookmarks': 'Bookmarks',
  'pixiv.noBookmarks': 'No bookmarks found.',
  'pixiv.collectionCreate': 'Create author collection',
  'pixiv.collectionOpen': 'Open collection',
  'pixiv.collectionSync': 'Sync new works',
  'pixiv.collectionSyncing': 'Collection syncing…',
  'pixiv.collectionReconcile': 'Full reconcile',
  'pixiv.collectionSubscribe': 'Subscribe to updates',
  'pixiv.collectionUnsubscribe': 'Unsubscribe updates',
  'pixiv.collectionQueued': 'Author collection sync queued',
  'pixiv.collectionConfirm': 'Download all {count} works into one author collection?',
  'pixiv.collectionReconcileConfirm':
    'Scan the complete Pixiv catalogue and mark missing source works?',
  'pixiv.collectionWorks': '{count} works',
  'pixiv.collectionMissing': '{count} missing at source',
  'pixiv.collectionSourceMissing': 'missing at source',
  'pixiv.followOnPixiv': 'Follow on Pixiv',
  'pixiv.unfollowOnPixiv': 'Unfollow on Pixiv',
  ...
  'backups.title': 'Database Backups',
  'backups.loadingPath': 'Loading backup path',
  'backups.runNow': 'Create backup',
  'backups.runQueued': 'Database backup queued',
  'backups.runFailed': 'Failed to queue database backup',
  'backups.loadFailed': 'Failed to load backups',
  'backups.empty': 'No database backups found',
  'backups.delete': 'Delete backup',
  'backups.deleteConfirm': 'Delete this database backup?',
  'backups.deleted': 'Backup deleted',
  'backups.deleteFailed': 'Failed to delete backup',
  'backups.missingFile': 'missing file',
  ...
  'dedup.tier2Desc': 'Optionally suggests which version to keep using resolution and file size.',
  'dedup.tier2RequiresTier1': 'Requires Tier 1 to be enabled',
  'dedup.reviewTitle': 'Review Queue',
  'dedup.filterAll': 'All',
  'dedup.filterCandidate': 'T1 Similar Candidates',
  ...
  'dedup.pixelDelta': 'Pixel count Δ {pct}%',
  'dedup.sizeDelta': 'File size Δ {pct}%',
  ...
  'dedup.confirmGlobalReplace':
    'This replaces {count} references to the other version across all galleries. Continue?',
  'dedup.zoomIn': 'Zoom in',
  'dedup.zoomOut': 'Zoom out',
  'dedup.zoomReset': 'Reset zoom',
  ...
  'dedup.confirmFullRescan':
    'Rebuild automatic detection evidence? Your review decisions will be preserved.',
  ...
  'dedup.tier0Note':
    'Tier 0: byte-identical files share storage; gallery pages are never removed automatically.',
  'dedup.processing': 'Processing',
  'dedup.pending': 'Pending',
  'dedup.tierComplete': 'Complete',
  'dedup.tierWaiting': 'Waiting',
  'dedup.lastRunComplete': 'Last scan completed',
  'dedup.lastRunFailed': 'Last scan failed',
  'dedup.lastRunDuration': 'Duration {duration}',
  ...
  'settings.accentPickCustom': 'Pick custom color',
  'settings.accentReset': 'Reset to default',
  'settings.customThemeColors': 'Custom theme colors',
  'settings.customThemeBg': 'Background',
  'settings.customThemeCard': 'Card',
  'settings.customThemeText': 'Text',
  'settings.customThemeReset': 'Reset to defaults',
  'settings.customThemeHint': 'Borders and secondary text are derived automatically.',
  'settings.contrastWarningText': 'Low contrast: text may be hard to read on this background.',
  'settings.contrastWarningAccent': 'Low contrast: white text on this accent may be hard to read.',
  'settings.displayDensity': 'Display density and type size',
  'settings.gridDensity': 'Gallery grid density',
  'settings.gridDensityDesc':
    'Choose the default spacing and responsive column density for Library cards.',
  'settings.gridDensity.spacious': 'Spacious',
  'settings.gridDensity.comfortable': 'Comfortable',
  'settings.gridDensity.compact': 'Compact',
  'settings.gridColumns': 'Maximum desktop columns',
  'settings.gridColumnsAuto': 'Automatic (density preset)',
  'settings.gridColumnsCount': '{count} columns',
  'settings.gridColumnsDesc': 'Smaller containers automatically use fewer columns.',
  'settings.fontScale': 'Global UI text size',
  'settings.fontScaleDesc': 'Scales rem-based interface text and spacing on this account.',
  ...
  // ── SAQ Queue Dashboard (admin) ──
  'admin.queue.title': 'Queue Dashboard',
  'admin.queue.active': 'Active',
  'admin.queue.queued': 'Queued',
  'admin.queue.scheduled': 'Scheduled',
  'admin.queue.workers': 'Workers',
  'admin.queue.uptime': 'Uptime',
  'admin.queue.completed': 'Completed',
  'admin.queue.failed': 'Failed',
  'admin.queue.retried': 'Retried',
  'admin.queue.noWorkers': 'No workers connected',
  'admin.queue.jobs': 'Jobs',
  'admin.queue.allStatuses': 'All Statuses',
  'admin.queue.allFunctions': 'All Functions',
  'admin.queue.noJobs': 'No jobs found',
  'admin.queue.function': 'Function',
  'admin.queue.status': 'Status',
  'admin.queue.progress': 'Progress',
  'admin.queue.attempts': 'Attempts',
  'admin.queue.kwargs': 'Parameters',
  'admin.queue.error': 'Error',
  'admin.queue.result': 'Result',
  'admin.queue.retry': 'Retry',
  'admin.queue.abort': 'Abort',
  'admin.queue.startedAt': 'Started',
  'admin.queue.completedAt': 'Completed',
  'admin.queue.retrySuccess': 'Job retried',
  'admin.queue.abortSuccess': 'Job aborted',
  'admin.queue.jobDetail': 'Job Details',
  'admin.queue.jobMeta': 'Metadata',
  'admin.queue.jobResult': 'Result',
  'admin.queue.jobError': 'Error',
  ...
  // ── Novels ──
  'nav.novels': 'Novels',
  'dashboard.quickLinks.novelsDesc': 'Read and edit your novel library',
  'novels.title': 'Novels',
  'novels.works': 'Works',
  'novels.chapters': 'Chapters',
  'novels.chapterCount': '{count} chapters',
  'novels.continue': 'Continue reading',
  'novels.read': 'Read',
  'novels.edit': 'Edit',
  'novels.save': 'Save',
  'novels.cancel': 'Cancel',
  'novels.search': 'Search',
  'novels.searchPlaceholder': 'Search all novels…',
  'novels.searchResults': 'Search results',
  'novels.noResults': 'No results',
  'novels.history': 'History',
  'novels.diff': 'Changes',
  'novels.compareWith': 'Compare with {rev}',
  'novels.compareBase': 'Comparing against {rev}',
  'novels.compareClear': 'Clear comparison',
  'novels.revertTo': 'Restore version {rev}',
  'novels.revertConfirm': 'Restore this file to version {rev}? A new commit is added; history is kept.',
  'novels.reverted': 'Version restored',
  'novels.revertFailed': 'Could not restore that version',
  'novels.format': 'Format',
  'novels.checkFormat': 'Check format',
  'novels.formatIssueCount': '{count} format issues',
  'novels.formatClean': 'Format matches FORMAT.md',
  'novels.formatFix': 'Fix automatically',
  'novels.formatFixed': 'Fixed {count} rule(s)',
  'novels.formatNothingToFix': 'Nothing to fix automatically',
  'novels.formatFixFailed': 'Could not apply the fixes',
  'novels.formatAtLine': 'Line {line}',
  'novels.lint.chapter_title_has_hash': 'Chapter title must not start with #',
  'novels.lint.act_title_has_chapter_number': 'Act title must not carry the chapter number',
  'novels.lint.act_title_wrong_level': 'Act title must be ### , not ####',
  'novels.lint.act_title_bold_instead_of_heading': 'Act title uses bold instead of a heading',
  'novels.lint.act_title_redundant_bold': 'Act heading has redundant bold',
  'novels.lint.metadata_colon_outside_bold': 'Metadata colon belongs inside the bold',
  'novels.lint.dialogue_colon_outside_bold': 'Dialogue colon belongs inside the bold',
  'novels.lint.halfwidth_paren_marker': 'Marker uses half-width parentheses',
  'novels.lint.mixed_paren': 'Mismatched parentheses',
  'novels.lint.inner_view_inside_blockquote': 'Inner-view heading must sit outside the blockquote',
  'novels.lint.missing_chapter_end_marker': 'Missing the （chapter 完） end marker',
  'novels.outline': 'Plot outline',
  'novels.outlineMissing': 'No outline yet — create {path}',
  'novels.outlineEmpty': 'No plot nodes found in the outline',
  'novels.outlineWritten': 'written',
  'novels.outlinePlanned': 'planned',
  'novels.backlinks': 'Backlinks',
  'novels.charCount': '{count} chars',
  'novels.summary': 'Summary',
  'novels.editSummary': 'Edit summary',
  'novels.summaryPlaceholder': 'One line: what happens in this chapter',
  'novels.summarySaved': 'Summary saved',
  'novels.summaryFailed': 'Could not save the summary',
  'novels.summaryConflict': 'Someone else changed this file while you were editing',
  'novels.summaryDiscardMine': 'Discard mine',
  'novels.summaryOverwrite': 'Overwrite anyway',
  'novels.tableOfContents': 'Contents',
  'novels.prevChapter': 'Previous',
  'novels.nextChapter': 'Next',
  'novels.locked': 'Repo is locked by a conflict — resolve it on the desktop.',
  'novels.unpushed': '{count} unpushed',
  'novels.sync': 'Sync',
  'novels.synced': 'Synced',
  'novels.reset': 'Reset to remote',
  'novels.resetConfirm': 'Discard local state and reset to the remote? Admin only.',
  'novels.resetDone': 'Reset to remote',
  'novels.draftRestored': 'Restored an unsaved draft',
  'novels.restoreDraft': 'Restore draft',
  'novels.discardDraft': 'Discard draft',
  'novels.staleConflict':
    'This chapter changed since you opened it. Review both versions before saving.',
  'novels.currentVersion': 'Current version on server',
  'novels.yourVersion': 'Your version',
  'novels.saved': 'Saved',
  'novels.saveFailed': 'Save failed',
  'novels.loadFailed': 'Failed to load',
  'novels.noWorks': 'No works found',
  'novels.commitMessage': 'Commit message',
  'novels.fontSize': 'Font size',
  'novels.theme': 'Theme',
  ...
  'novels.graph': 'Knowledge graph',
  'novels.notes': 'Notes',
  'novels.appearances': 'Appearances',
  'novels.entityCard': 'Entity',
  'novels.plotTimeline': 'Plot timeline',
  'novels.reindex': 'Rebuild index',
  'novels.reindexed': 'Index rebuilt',
  'novels.graphEmpty': 'No index yet — add Setting notes or rebuild the index',
  'novels.filterByType': 'Type',
  'novels.filterByTag': 'Tag',
  'novels.allTypes': 'All types',
  'novels.noteType.character': 'Character',
  'novels.noteType.location': 'Location',
  'novels.noteType.event': 'Event',
  'novels.noteType.item': 'Item',
  'novels.noteType.concept': 'Concept',
  'novels.mentionCount': '{count} mentions',
  ...
  'explorer.libraryTree': 'Library tree',
  'explorer.layoutMode': 'Navigation layout',
  'explorer.treeLayout': 'Tree navigation',
  'explorer.columnLayout': 'Column navigation',
  'explorer.keyboardShortcuts': 'Keyboard shortcuts',
  'explorer.navigateItems': 'Move focus',
  'explorer.openItem': 'Open focused item',
  'explorer.extendSelection': 'Extend selection',
  'explorer.clearSelection': 'Clear selection or focus',
  'explorer.back': 'Go to parent',
  'explorer.focusSearch': 'Focus search',
  'explorer.switchLayout': 'Switch navigation layout',
  'explorer.switchView': 'Switch grid or list view',
  'explorer.cyclePane': 'Cycle navigation, content, and inspector',
  'explorer.sources': 'Sources',
  'explorer.organize': 'Organize',
  'explorer.smartViews': 'Smart Views',
  'explorer.missingMetadata': 'Missing metadata',
  'explorer.duplicates': 'Duplicate review',
  'explorer.trash': 'Trash',
  'explorer.physicalLibraries': 'Physical libraries',
  'explorer.physicalSize': 'Physical size',
  'explorer.logicalSize': 'Logical content size',
  'explorer.uniqueCasSize': 'Unique CAS size',
  'explorer.readOnlyPhysical': 'External folders are read-only in Workbench.',
  'explorer.calculating': 'Calculating…',
  'explorer.pages': 'pages',
  'explorer.toggleSelection': 'Toggle selection',
  'explorer.inspectorEmpty': 'Select an item to inspect its metadata and storage usage.',
  'explorer.source': 'Source',
  'explorer.metadata': 'Metadata',
  'explorer.visibility': 'Visibility',
  'explorer.type': 'Type',
  'explorer.importStatus': 'Import status',
  'explorer.imported': 'Imported',
  'explorer.notImported': 'Not imported',
  'explorer.selectAllResults': 'Select all results',
  'explorer.refreshSize': 'Refresh folder size',
  'explorer.editMetadata': 'Edit metadata',
  'explorer.metadataUpdated': 'Metadata updated',
  'explorer.manualFieldsLocked':
    'Manual values are locked. Source refreshes will show a proposed diff instead of overwriting them.',
  'explorer.keep': 'Keep',
  'explorer.set': 'Set',
  'explorer.clear': 'Clear',
  'explorer.mixedValues': 'Mixed values',
  'explorer.merge': 'Merge',
  'explorer.mergeGalleries': 'Merge galleries',
  'explorer.mergeTarget': 'Target gallery',
  'explorer.imagesAdded': 'Images added',
  'explorer.exactSkipped': 'Exact SHA skipped',
  'explorer.similarReview': 'Similar for review',
  'explorer.merge404Warning':
    'Sources will be moved to Trash and their old routes will immediately return 404. Restoring a source does not undo the merged target.',
  'explorer.mergeComplete': 'Galleries merged',
  'explorer.tags': 'Tags',
  'explorer.importFolder': 'Import folder',
  'explorer.importQueued': 'Folder import queued',
  'explorer.manageTags': 'Manage tags',
  'explorer.manageCollections': 'Manage collections',
  'explorer.collections': 'Collections',
  'explorer.chooseCollection': 'Choose a collection',
  'explorer.add': 'Add',
  'explorer.remove': 'Remove',
  'explorer.favorite': 'Favorite',
  'explorer.readLater': 'Read later',
  'explorer.rating': 'Rating',
  'explorer.bulkActionComplete': 'Bulk action completed',
  'explorer.resolveConflicts': 'Resolve metadata conflicts',
  'explorer.finderColumns': 'Column navigation',
  'explorer.artists': 'Artists',
  'explorer.savedSearches': 'Saved searches',
  'explorer.moreActions': 'More',
  'explorer.unfavorite': 'Remove favorite',
  'explorer.removeReadLater': 'Remove from read later',
  'explorer.reviewPairs': 'Review pairs',
  'explorer.provenance': 'Provenance and locks',
  'explorer.sourceProposal': 'Source proposal',
  'explorer.history': 'Recent changes',
  'nav.datasets': 'Datasets',
  'dashboard.quickLinks.datasetsDesc': 'Curate persistent AI training image sets',
  'nav.training': 'Training assets',
  'dashboard.quickLinks.trainingDesc': 'Manage LoRA models and ComfyUI workflow images',
  'nav.stats': 'Reading stats',
  'dashboard.quickLinks.statsDesc': 'Review reading trends, tags, and unfinished galleries',
  'datasets.title': 'Training Datasets',
  'datasets.subtitle':
    'Build reviewable image sets from galleries, collections, or individual images.',
  'datasets.create': 'Create Dataset',
  'datasets.created': 'Dataset created',
  'datasets.updated': 'Dataset updated',
  'datasets.deleted': 'Dataset deleted',
  'datasets.confirmDelete': 'Delete this dataset? The source images will not be removed.',
  'datasets.empty': 'No datasets yet.',
  'datasets.noDescription': 'No description',
  'datasets.name': 'Name',
  'datasets.namePlaceholder': 'Portrait LoRA candidates...',
  'datasets.description': 'Description',
  'datasets.descriptionPlaceholder': 'Optional curation notes...',
  'datasets.selectionHint':
    'Enter IDs separated by commas or spaces. Only images you can access are added.',
  'datasets.galleryIds': 'Gallery IDs',
  'datasets.collectionIds': 'Collection IDs',
  'datasets.imageIds': 'Image IDs',
  'datasets.idsPlaceholder': '12, 34, 56',
  'datasets.delete': 'Delete dataset',
  'datasets.edit': 'Edit dataset',
  'datasets.imageCount': '{count} images',
  'datasets.galleryCount': '{count} galleries',
  'datasets.excludedCount': '{count} excluded',
  'datasets.includedCount': '{count} included',
  'datasets.addMembers': 'Add Images',
  'datasets.membersAdded': '{count} images added',
  'datasets.imageExcluded': 'Image excluded',
  'datasets.imageRestored': 'Image restored',
  'datasets.noIncludedImages': 'No included images.',
  ...
  'datasets.phashDistance': 'Near-duplicate pHash distance',
  ...
  'datasets.previewPhashDuplicate': '{count} near-duplicate',
  'datasets.previewUnknownPhash': '{count} without pHash',
  ...
  'datasets.exclusionPhashDuplicate': 'Near-duplicate image',
  'datasets.captions': 'Captions',
  'datasets.captionReview': 'Caption review and generation',
  'datasets.captionReviewHint':
    'Generate natural-language captions, edit each image, or apply batch changes.',
  'datasets.tagThreshold': 'Dataset tag confidence threshold',
  'datasets.generateCaptions': 'Generate captions',
  'datasets.captionsQueued': 'Caption generation queued',
  'datasets.captionsChanged': '{count} captions changed',
  'datasets.triggerWordPlaceholder': 'Trigger word',
  'datasets.prependTrigger': 'Prepend to all',
  'datasets.captionSearch': 'Search captions',
  'datasets.captionReplacement': 'Replacement',
  'datasets.replaceCaptions': 'Replace all',
  'datasets.imageCaption': 'Image caption',
  'training.title': 'Training assets',
  'training.description': 'Store trained LoRAs and round-trip ComfyUI PNG workflows.',
  'training.uploadLora': 'Upload LoRA',
  'training.modelName': 'Model name',
  'training.datasetIdOptional': 'Dataset ID (optional)',
  'training.triggerWords': 'trigger, words',
  'training.paramsJson': 'Training parameters JSON',
  'training.upload': 'Upload',
  'training.uploaded': 'LoRA uploaded',
  'training.importComfy': 'Import ComfyUI PNG',
  'training.importWorkflow': 'Import workflow image',
  'training.imported': 'Imported into gallery {id}',
  'training.library': 'LoRA library',
  'training.noTriggerWords': 'No trigger words',
  'training.download': 'Download',
  'training.empty': 'No LoRA models yet.',
  'stats.title': 'Reading statistics',
  'stats.description': 'Your activity over the last 30 days.',
  'stats.trend': 'Reading trend',
  'stats.trendAria': 'Reading events by day',
  'stats.events': '{count} event|{count} events',
  'stats.noEvents': 'No reading events yet.',
  'stats.frequentTags': 'Frequently read tags',
  'stats.continueReading': 'Continue reading',
  'stats.galleryFallback': 'Gallery #{id}',
  'stats.pageProgress': 'Page {page} of {pages}',
  'share.unavailable': 'This share link is unavailable or has expired.',
  'share.fromJyzrox': 'Shared from Jyzrox',
  'share.untitled': 'Untitled gallery',
  'share.images': '{count} image|{count} images',
  'share.pageAlt': 'Page {page}',
  'import.overview': 'Overview',
  'import.conflicts.tab': 'Conflicts',
  'import.conflicts.title': 'Import conflicts',
  'import.conflicts.description': 'Review source paths that already exist in the library.',
  'import.conflicts.manual': 'Manual review',
  'import.conflicts.autoMerge': 'Auto merge',
  'import.conflicts.mergeFiles': 'Merge new files',
  'import.conflicts.skip': 'Skip',
  'import.conflicts.empty': 'No pending conflicts.',
  'import.conflicts.resolved': 'Conflict resolved',
  'tags.anomalies.tab': 'Anomalies',
  'tags.anomalies.minDifference': 'Minimum confidence difference',
  'tags.anomalies.gallery': 'Gallery',
  'tags.anomalies.tag': 'Tag',
  'tags.anomalies.ai': 'AI',
  'tags.anomalies.metadata': 'Metadata',
  'tags.anomalies.suggestion': 'Suggestion',
  'tags.anomalies.reviewAiOnly': 'Review AI-only tag',
  'tags.anomalies.reviewMissingAi': 'Review missing AI match',
  'tags.anomalies.empty': 'No anomalies at this threshold.',
  'tags.total': '{count} tag|{count} tags',
  'library.share': 'Share',
  'library.shareCopied': 'Share link copied (expires in 7 days, R18 filtered)',
  'library.accessUserIds': 'User IDs to grant read access (comma separated)',
  'library.privateVisibilityConfirm':
    'Use private visibility? Choose Cancel for public visibility.',
  'library.accessUpdated': 'Gallery access updated',
  'library.manageAccess': 'Manage access',
  'library.versions': 'Versions',
  'library.linkVersionPrompt': 'Gallery ID to link as another version',
  'library.versionLinked': 'Version linked',
  'library.linkVersion': 'Link version',
  'library.mergeGalleryPrompt': 'Gallery ID to merge into this gallery',
  'library.mergeGalleryConfirm': 'Move all images and user state into this gallery?',
  'library.galleryMerged': 'Gallery merged',
  'library.merge': 'Merge',
  'library.sourceLookupComplete': 'Source lookup complete: {count} galleries updated',
  'library.sourceLookupLimit': 'Select up to 6 images (SauceNAO free-tier window)',
  'library.findSources': 'Find sources ({count})',
  'browse.category.doujinshi': 'Doujinshi',
  'browse.category.manga': 'Manga',
  'browse.category.artistCg': 'Artist CG',
  'browse.category.gameCg': 'Game CG',
  'browse.category.western': 'Western',
  'browse.category.nonH': 'Non-H',
  'browse.category.imageSet': 'Image Set',
  'browse.category.cosplay': 'Cosplay',
  'browse.category.asianPorn': 'Asian Porn',
  'browse.category.misc': 'Misc',
  'browse.cron.everyHour': 'Every hour',
  'browse.cron.every2Hours': 'Every 2 hours',
  'browse.cron.every6Hours': 'Every 6 hours',
  'browse.cron.daily': 'Daily',
  'browse.language.english': 'English',
  'browse.language.chinese': 'Chinese',
  'browse.language.japanese': 'Japanese',
  'browse.language.korean': 'Korean',
  'browse.language.spanish': 'Spanish',
  ...
  'tagInput.includeTags': 'Include Tags',
  'tagInput.excludeTags': 'Exclude Tags',
  'reader.go': 'Go',
  'pixiv.visibilityPublic': 'Public',
  'pixiv.visibilityPrivate': 'Private',
  'admin.sites.sleepRequestExample': 'e.g. 2 or 1-5',
  'explorer.visibilityPublic': 'Public',
  'explorer.visibilityPrivate': 'Private',
  'queue.queuedSuccessWithJob': 'Queued successfully (job: {id})',
}
